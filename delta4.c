...
int main() {
	FILE *fp;
	fp = fopen("delta4_double.txt", "w+");
	double x1, x2, x3, x4, x5, x6;
	for (x1 = 4.; x1 <= 3969./625.; x1 += 0.1)
		for (x2 = 4.; x2 <= 3969./625.; x2 += 0.1)
			for (x3 = 4.; x3 <= 3969./625.; x3 += 0.1)	
				for (x4 = 4.; x4 <= 3969./625.; x4 += 0.1)
					for (x5 = 4.; x5 <= 3969./625.; x5 += 0.1)
						for (x6 = 4.; x6 <= 3969./625.; x6 += 0.1)
